...
class SPLC_Free_Loader {
	 ...
	 */
	function admin_menu() {
		//add_submenu_page( 'edit.php?post_type=wpl_logo_carousel', __( 'Logo Carousel Pro', 'logo-carousel-free' ), __( 'Premium', 'logo-carousel-free' ), 'manage_options', 'lc_upgrade', array( $this, 'upgrade_page_callback' ) );
		...
		<div class="wrap about-wrap sp-lc-help sp-lc-upgrade">
			...
			<h2 class="sp-lc-text-center sp-lc-promo-video-title">Watch How <b>Logo Carousel Pro</b> Works</h2>
				...
				<div class="sp-lc-join-community sp-lc-text-center">
					...
					<a class="lc-upgrade-btn" target="_blank" href="https://shapedplugin.com/plugin/logo-carousel-pro/">Get a license instantly</a>
				...
				<div class="sp-lc-upgrade-sticky-footer sp-lc-text-center">
					<p><a href="https://shapedplugin.com/demo/logo-carousel-pro/" target="_blank" class="button
					button-primary">Live Demo</a> <a href="https://shapedplugin.com/plugin/logo-carousel-pro/" target="_blank" class="button button-primary">Upgrade Now</a></p>
				</div>
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="sp-lc-feature sp-lc-text-center">
						...
						<a href="https://shapedplugin.com/docs/docs/logo-carousel/introduction/" target="_blank" class="button button-primary">Documentation</a>
					</div>
				</div>
				<div class="col">
					<div class="sp-lc-feature sp-lc-text-center">
