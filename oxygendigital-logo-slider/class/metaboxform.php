...
class SPLC_MetaBoxForm {
	...
	public function url( array $args ) {
		...
		echo $this->field_before( $args );
		echo sprintf( '<input type="text" class="wpl-input-text" placeholder="http://example.com" value="%1$s" id="%2$s" name="%3$s">%4$s', $value, $args['id'], $name, $after );
		echo $this->field_after();
	...
	public function typography_type( array $args ) {
		...
		echo '<div class="sp_lc_font_field">
            <div class="sp-element sp-typography-family">
                Font Family <br>
                <select  name="sp-typo-family" id="sp-typo-family" class="sp-lc-select">
            ...
            <div class="sp-element sp-typography-variant">
                Font Weight <br>
                <select name="sp-typo-variant" id="sp-typo-variant" class="sp-lc-select">
            ...
            <div class="sp-element sp-field-number sp-pseudo-field small-input sp-font-size">
                Font Size <br>
                <input type="number" class="sp-lc-input-number" value="16" title="Font Size">
            </div>
            
            <div class="sp-element sp-field-number sp-pseudo-field small-input sp-font-height">
                Line Height <br>
                <input type="number" class="sp-lc-input-number" value="20" title="Line Height">
            </div>
            <div class="sp-divider"></div>
            <div class="sp-element sp-field-select sp-pseudo-field small-input sp-font-alignment">
                Alignment <br>
                <select name="sp-font-alignment" id="sp-font-alignment" class="sp-lc-select">
            ...
            <div class="sp-element sp-field-select sp-pseudo-field small-input sp-font-transform">
                Transform <br>
                <select name="sp-font-transform" id="sp-font-transform" class="sp-lc-select">
            ...
            <div class="sp-element sp-field-select sp-pseudo-field small-input sp-font-spacing">
                Letter Spacing <br>
                <select name="sp-font-spacing" id="sp-font-spacing" class="sp-lc-select">
            ...
            <div class="sp-element sp-typography-color">
                Color <br>
                <div class="sp-element sp-field-color_picker sp-pseudo-field">
                    <input type="text" class="wpl-color-picker" value="#444444" id="sp-field-color_picker" name="sp-field-color_picker">
                </div>
            </div>
		...
		<div class="sp-lc-image-field">
			<label>
				<div class="sp-lc-image-field-image">
					...
					<img src="<?php echo SP_LC_URL . 'admin/assets/images/carousel.png'; ?>" alt="Carousel">
				</div>
				<p>Carousel</p>
			</label>
			<!--
			<label>
				<div class="sp-lc-image-field-image">
					...
					<img src="<?php echo SP_LC_URL . 'admin/assets/images/grid.png'; ?>" alt="Grid">
				</div>
				<p>Grid</p>
			</label>
			<label>
				<div class="sp-lc-image-field-image">
					<strong class="sp-lc-pro-only">PRO</strong><input type="radio" name="sp_lc_shortcode_options[carousel_layout]" value="filter">
					<img src="<?php echo SP_LC_URL . 'admin/assets/images/filter.png'; ?>" alt="Filter">
				</div>
				<p>Filter</p>
			</label>
			<label>
				<div class="sp-lc-image-field-image">
					...
					<img src="<?php echo SP_LC_URL . 'admin/assets/images/list.png'; ?>" alt="List">
				</div>
				<p>List</p>
			</label>
			<label>
				<div class="sp-lc-image-field-image">
					...
					<img src="<?php echo SP_LC_URL . 'admin/assets/images/inline.png'; ?>" alt="Inline">
				</div>
				<p>Inline</p>
			</label>
			-->
	...
	public function display_logos( array $args ) {
		...
		<option value="category">Category (Pro)</option>
		<option value="specific">Specific (Pro)</option>
		<?php
		echo '</select>';
		echo $this->field_after();
	}
