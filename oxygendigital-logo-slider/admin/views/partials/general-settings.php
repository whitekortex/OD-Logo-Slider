...
<div id="splc-tab-1" class="sp-lc-tab-content nav-tab-active">
	...
	$this->metaboxform->number(
		array(
			...
			'desc'    => __( 'Set number of column(s) in large desktop for the screen larger than 1280px.', 'logo-carousel-free' ),
			'default' => 5,
		)
	);
	$this->metaboxform->number(
		array(
			...
			'desc'    => __( 'Set number of column(s) in desktop for the screen smaller than 1280px.', 'logo-carousel-free' ),
			'default' => 5,
		)
	);
	...
	$this->metaboxform->number(
		array(
			...
			'name'    => __( 'Column(s) in Small Desktop', 'logo-carousel-free' ),
			'desc'    => __( 'Set number of column(s) in small desktop for the screen smaller than 980px.', 'logo-carousel-free' ),
			'default' => 4,
		)
	);
	$this->metaboxform->number(
		array(
			...
			'desc'    => __( 'Set number of column(s) in tablet for the screen smaller than 736px.', 'logo-carousel-free' ),
			'default' => 3,
		)
	);
	$this->metaboxform->number(
		array(
			...
			'desc'    => __( 'Set number of column(s) in mobile for the screen smaller than 480px.', 'logo-carousel-free' ),
			'default' => 2,
		)
	);
